...
class _EventWidgetState extends State<EventWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResulth2v = await GetWeatherCall.call(
        city: 'Tunisia',
      );

      if ((_model.apiResulth2v?.succeeded ?? true)) {
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  context.pushNamed(AjoutEventWidget.routeName);
                },
                child: Icon(
                  Icons.add,
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          '${listViewEventRecord.price.toString()} DT',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          '${dateTimeFormat("yMMMd", listViewEventRecord.date)}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
