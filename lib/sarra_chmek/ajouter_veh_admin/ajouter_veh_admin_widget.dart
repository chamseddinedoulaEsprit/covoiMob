...
import 'ajouter_veh_admin_model.dart';
export 'ajouter_veh_admin_model.dart';

class AjouterVehAdminWidget extends StatefulWidget {
  const AjouterVehAdminWidget({super.key});

  static String routeName = 'Ajouter_Veh_Admin';
  static String routePath = '/ajouterVehAdmin';

  @override
  State<AjouterVehAdminWidget> createState() => _AjouterVehAdminWidgetState();
}

class _AjouterVehAdminWidgetState extends State<AjouterVehAdminWidget> {
  late AjouterVehAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjouterVehAdminModel());

    _model.typeVehiculeTextController ??= TextEditingController();
    _model.typeVehiculeFocusNode ??= FocusNode();

    _model.prixTextController ??= TextEditingController();
    _model.prixFocusNode ??= FocusNode();

    _model.disponibiliteTextController ??= TextEditingController();
    _model.disponibiliteFocusNode ??= FocusNode();

    _model.lieuRetraitTextController ??= TextEditingController();
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await VehiculeRecord.collection
                          .doc()
                          .set(createVehiculeRecordData(
                            type: _model.typeVehiculeTextController.text,
                            imagePath: ImageuploadCall.imageUrl(
                              (_model.apiResult925?.jsonBody ?? ''),
                            ).toString(),
                            prix:
                                double.tryParse(_model.prixTextController.text),
