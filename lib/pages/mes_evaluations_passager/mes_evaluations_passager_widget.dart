...
import 'mes_evaluations_passager_model.dart';
export 'mes_evaluations_passager_model.dart';

class MesEvaluationsPassagerWidget extends StatefulWidget {
  const MesEvaluationsPassagerWidget({super.key});

  static String routeName = 'mesEvaluationsPassager';
  static String routePath = '/mesEvaluationsPassager';

  @override
  State<MesEvaluationsPassagerWidget> createState() =>
      _MesEvaluationsPassagerWidgetState();
}

class _MesEvaluationsPassagerWidgetState
    extends State<MesEvaluationsPassagerWidget> {
  late MesEvaluationsPassagerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MesEvaluationsPassagerModel());
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              context.pushNamed(
                                                  MesEvaluationsPassagerWidget
                                                      .routeName);
                                            },
                                            child: Text(
                                              'Mes Évaluations comme passager',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
                        ...
                        child: MouseRegion(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              context.goNamedAuth(
                                  Welcome0Widget.routeName, context.mounted);
                            },
                            child: AnimatedContainer(
                              duration: Duration(milliseconds: 150),
                              curve: Curves.easeInOut,
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Mes retours sur les conducteurs',
                        ...
                        return Padding(
                          ...
                          child: StreamBuilder<UserRecord>(
                            stream: UserRecord.getDocument(
                                listViewAvisConducteurRecord.idConducteur!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
