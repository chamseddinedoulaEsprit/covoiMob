...
class AddCouponWidget extends StatefulWidget {
  ...
  static String routeName = 'AddCoupon';
  static String routePath = '/addCoupon';
...
class _AddCouponWidgetState extends State<AddCouponWidget> {
  ...
  void initState() {
    ...
    _model.nomFocusNode!.addListener(() => safeSetState(() {}));
    _model.phoneNumberTextController ??= TextEditingController();
    _model.phoneNumberFocusNode ??= FocusNode();
    _model.phoneNumberFocusNode!.addListener(() => safeSetState(() {}));
    _model.cinTextController ??= TextEditingController();
    _model.cinFocusNode ??= FocusNode();
    _model.cinFocusNode!.addListener(() => safeSetState(() {}));
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller: _model.cinTextController,
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .cinTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [_model.cinMask],
                                    ),
                                    FFButtonWidget(
                                      onPressed: () async {
                                        safeSetState(() {
                                          _model.nomTextController?.text =
                                              functions.generateCoupon();
                                        });
                                      },
                                      text: 'GenerateCode',
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await couponRecordReference.set(createCouponRecordData(
                          code: _model.nomTextController.text,
                          nbUtilsMax:
                              int.tryParse(_model.cinTextController.text),
                          promo: int.tryParse(
                              _model.phoneNumberTextController.text),
                          nbUtilisations: 0,
                        ));
                        _model.res = CouponRecord.getDocumentFromData(
                        ...
                        context.pushNamed(ListAbnWidget.routeName);
